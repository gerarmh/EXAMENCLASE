...
<head>
    ...
    <!--Se incluye archivo que contiene el inicio de sesion-->
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    $sql = "SELECT colaboradores.id, colaboradores.nombrecolab, colaboradores.apellidop, colaboradores.apellidom, colaboradores.telefono, 
            ...
            FROM colaboradores INNER JOIN sucursales ON colaboradores.unidad_negocio=sucursales.id WHERE colaboradores.id='" . $id . "'";
    ...
    $sql1 = "SELECT colaboradores.id, colaboradores.nombrecolab, colaboradores.apellidop, colaboradores.apellidom, colaboradores.telefono, 
            ...
            FROM colaboradores 
            INNER JOIN sucursales ON colaboradores.numsucursal=sucursales.id WHERE colaboradores.id='" . $id . "'";
            ...
            <div class="box">
                <div class="equipo">
                    ...
                    <form method="GET" action="modificarcolabll.php">
                        ...
                        <input type="button" value="Cancelar" OnClick="location.href='consultacolab.php'" />
                    </form>
                </div>
            </div><br>
            </form>
