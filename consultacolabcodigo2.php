    ...
    ?>
            <div class="box">
                <div class="equipo">
                    ...
                    <form method="GET" action="consultacolabcodigo3.php">
                    ...
                    <input type="hidden" name="id" value="<?php echo $reg['id'] ?>">
                        ...
                        data-content="No puedes modificar este campo!."></i>
                    </br><!--Salto de linea-->
                        ...
                        <input type="button" value="Cancelar" OnClick="location.href='consultacolabcodigo.php'" />
                    </form>
                </div>
            </div><br>
            </form>
