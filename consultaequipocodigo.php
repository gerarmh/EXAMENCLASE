...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <form action="consultaequipocodigo2.php" method="POST">
        <div class="box">
            <div class="equipo">
            
                <h4>Consulta de equipos por la placa del equipo</h4>
                <br>
                <input type="text" name="placa" placeholder="No. Placa" required=""><br><br>
