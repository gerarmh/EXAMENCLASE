...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <form action="consultasucursalcodigo2.php" method="POST">
        <div class="box">
            <div class="equipo">
            
                <h4>Consulta de sucursales por numero de Sucursal.</h4>
                <br>
                <input type="text" name="numsucursal" placeholder="No. Sucursal" onkeypress="return solonumeros(event)" onpaste="return false" 
                required="" maxlength="4" minlength="4" pattern="[0-9]+"><br><br>
